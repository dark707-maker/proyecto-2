...
class Login : Gtk.Window
{
    ...
    public Login() : base("WELCOME")
    {
        ...
        boton1.Clicked += (sender, e) =>
        {
            ...
            {
                UsuarioActual = correo; // Guardar el correo del usuario
            ...
            else
            {
                ...
                Usuario usuarioEncontrado = listaUsuarios.BuscarUsuarioPorCorreo(correo);
                if (usuarioEncontrado != null && usuarioEncontrado.Contrasenia == contrasenia)
                {
                    UsuarioActual = correo; // Guardar el correo del usuario
                    RegistrarEntrada(correo); // Registrar la hora de entrada

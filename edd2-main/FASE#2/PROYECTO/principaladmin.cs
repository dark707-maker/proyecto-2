...
class Principaladmin : Gtk.Window {
    ...
    public ArbolAVL arbolRepuestos = ArbolAVL.ObtenerInstancia(); // Árbol AVL para repuestos
    
    public ArbolServicios arbolServicios = ArbolServicios.ObtenerInstancia(); // Árbol B para servicios
